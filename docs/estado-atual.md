...
(2026-09-22). Módulo Go com o endereço real.
...
Ambiente de validação original: macOS arm64, Go 1.27.1 oficial, sem instalação
global.
...
0.0.0.0. Não confundir recebimento de exemplo simulado com medição real. Contrato
